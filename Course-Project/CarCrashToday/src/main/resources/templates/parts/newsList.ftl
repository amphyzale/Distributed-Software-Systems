...
<#list page.content as message>
    <div class="col-sm-12">
        <div class="card mb-3 ">
            <div id="divx" <#if message.filename??>style="height: 10rem; overflow: hidden;" </#if>>

                <#if message.filename??>
                    <img class="card-img-top" src="/img/${message.filename}"  alt="Card image cap" onclick="changeImage('divx', this)">
                </#if>
            </div>
            <div class="card-body" >
                ...
                <div class="row <#if message.car2??>justify-content-md-center</#if>">
                    <div class="card m-2" >
                        <div class="card-body">
            ...
            <div class="card-footer" align="right">
                ...
                <#if message.author.id == currentUserId || isAdmin>
                    <#if message.status.id != 3 && (message.status.id != 2 || isAdmin)>
                        <a class="btn btn-primary" href="/user_news/${message.author.id}?message=${message.id}">Редактировать</a>
                        <#if isAdmin && message.status.id == 2>
                            <a class="btn btn-primary" href="/user_news/public/${message.author.id}?message=${message.id}">Опубликовать</a>
                        <#else>
