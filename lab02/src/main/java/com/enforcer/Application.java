...
public class Application {
    ...
    private void listAllUsers() throws IOException {
        ...
        String query = "select `name`, `birthDate`, `address`, `iq`  from owner order by `iq` desc";
    ...
    private void addUser() throws IOException {
        ...
        String query =
                "insert into owner (name, birthDate, address, iq)" +
                        " values (?, ?, ?, ?)";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        PreparedStatement stmt = null;
        ResultSet rs = null;

        System.out.println("Введите сведения о пользователе");
    ...
    private void editUser() throws IOException {
        ...
        String query = "update owner set name = ?, address = ?, iq = ? where id=?";
    ...
    private void listAllPets() throws IOException {
        ...
        String lineFormat = "%s. %s %s (%s) %s";
        String query = "select pet.name, pet.age, pet.type, owner.name  from pet join owner on pet.pet_owner_id = owner.id";
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
            stmt = this.connection.prepareStatement(query);
    ...
    private void addPet() throws IOException {
        ...
        String query =
                "insert into pet (name, age, type, pet_owner_id)" +
                        " values (?, ?, ?, ?)";
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        do {
            ...
            try {
                ...
                System.out.println("\tНекорректный возраст, попробуйте снова.");
            }
        } while (!flag);
